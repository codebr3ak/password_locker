...
def main():
    ...
    while True:
        ...
        if short_code == "ex":
            ...
            print("-"*10)
            print(
                f"Account succesfully created, username: {user_name}, password: {password}.")
        elif short_code == "li":
            print("")
            print("-"*100)
            ...
            if valid_user == user_name:
                print("-"*10)
                print(
                    f"Welcome to password vault {user_name}. To proceed, pick one of the options below:")
                while True:
                    print("-"*100)
                    ...
                    if short_code == "cc":
                        ...
                        print("*"*10)
                        print(
                            f"Account credentials saved as: Website {website}, Account name: {account_name} and Password: {password}")
                    elif short_code == "dc":
                        print(" ")
                        if display_credentials(user_name):
                            ...
                            for credentials in display_credentials(user_name):
                                print(
                                    f"Website: {website}, Account Name: {account_name}, Password {password}")
                            print("-"*100)
                        else:
                            print(" ")
